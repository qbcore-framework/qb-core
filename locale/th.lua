local Translations = {
    error = {
        ...
        server_already_open = 'เซิฟเวอร์เปิดแล้ว',
        server_already_closed = 'เซิฟเวอร์ปิดแล้ว',
        no_permission = 'คุณไม่มี่สิทธิ์สำหรับสิ่งนี้..',
        no_waypoint = 'ไม่ได้กำหนดจุดหมาย.',
        tp_error = 'ผิดพลาดขณะกำลังวาร์ป.',
        connecting_database_error = 'ฐานข้อมูลขัดข้องระหว่างกำลังเชื่อมต่อเซิฟเวอร์. (รัน sql server แล้วรึยัง?)',
        connecting_database_timeout = 'เชื่อมต่อกับฐานข้อมูลเกินเวลาที่กำหนด. (รัน sql server แล้วรึยัง?)',
    },
    success = {
