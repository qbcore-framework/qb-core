local Translations = {
    error = {
        ...
        duplicate_license = '[QBCORE] - Licença da Rockstar duplicada encontrada',
        no_valid_license  = '[QBCORE] - Nenhuma licença da Rockstar válida encontrada',
        not_whitelisted = '[QBCORE] - Você não está na lista branca(whitelist) deste servidor',
        ...
        connecting_database_error = '[QBCORE] - Ocorreu um erro de banco de dados ao conectar-se ao servidor. (O servidor SQL está ativado?)',
        connecting_database_timeout = '[QBCORE] - A conexão com o banco de dados expirou. (O servidor SQL está ativado?)',
    },
    success = {
