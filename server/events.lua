...
local function OnPlayerConnecting(name, setKickReason, deferrals)
    ...
    deferrals.update(string.format("Hello %s. Checking your Rockstar Games license...", name))
    ...
    if not license then
        deferrals.done("No valid Rockstar Games license was found. If you believe this is an error, try again. If the issue persists, please contact the server administrators.")
