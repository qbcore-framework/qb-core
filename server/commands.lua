...
QBCore.Commands.Add("givemoney", "Give A Player Money (Admin Only)", {{
    ...
    name = "moneytype",
    help = "Type of money (cash, bank, crypto)"
}, {
    name = "amount",
...
QBCore.Commands.Add("job", "Check Your Job", {}, false, function(source, args)
    ...
    TriggerClientEvent('QBCore:Notify', source,
        "Job: " .. Player.PlayerData.job.label .. " Grade: " .. Player.PlayerData.job.grade.name)
end)
    ...
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        if QBCore.Functions.HasPermission(v, "admin") then
            if QBCore.Functions.IsOptin(v) then
                ...
                TriggerEvent("qb-log:server:CreateLog", "ooc", "OOC", "white",
                    "**" .. GetPlayerName(source) .. "** (CitizenID: " .. Player.PlayerData.citizenid .. " | ID: " ..
                        source .. ") **Message:** " .. message, false)
            end
        end
    end
end)
