...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 8) -- Gets max players from config file, default 64
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { ['cash'] = 3500, ['bank'] = 1000, ['crypto'] = 0 } -- ['type']=startamount - Add or remove money types for your server (for ex. ['blackmoney']=0), remember once added it will not be removed from the database!
...
QBConfig.Player.MaxInvSlots = 85 -- Max inventory slots for a player
...
QBConfig.Server.discord = "https://discord.gg/CUgxsmXv" -- Discord invite link
