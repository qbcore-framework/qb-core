...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 1000, bank = 40000, shung = 0, rook = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Server.Discord = "discord.gg/everfall" -- Discord invite link
