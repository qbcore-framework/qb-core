...
QBConfig.Server.Permissions = {'director','senioradmin','admin','mod','helper','leo','ems','user'} -- Add as many groups as you want here after creating them in your server.cfg
